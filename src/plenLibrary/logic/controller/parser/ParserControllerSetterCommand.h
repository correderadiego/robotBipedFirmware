...
#define JOINT_VALUE_POSITION		VALUE_LENGTH + TRANSITION_TIME_LENGTH
...
#define LOOP_BEGIN_POSITION			NAME_POSITION + NAME_LENGTH
#define LOOP_END_LENGTH				2
#define LOOP_END_POSITION			LOOP_BEGIN_POSITION + LOOP_BEGIN_LENGTH
#define LOOP_COUNT_LENGTH			2
#define LOOP_COUNT_POSITION			LOOP_END_POSITION + LOOP_END_LENGTH
#define USE_JUMP_LENGTH				1
#define USE_JUMP_POSITION			LOOP_COUNT_LENGTH + LOOP_COUNT_POSITION
